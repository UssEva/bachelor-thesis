...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{description}
        \item[RQ 4 What bugs are found in comparison to \litterbox{}?] 
        Use \litterbox{} and \ngram{} to count how many bugs are found in the same set and compare the results. Analyze if \ngram{} finds bugs that are not detected by \litterbox{}. Classify which category of defective code was found: \textit{True Bug, Refactoring Opportunity and False Positive}.
    \end{description}
